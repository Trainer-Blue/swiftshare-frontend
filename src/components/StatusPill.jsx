...
const StatusPill = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-stone-50/50 dark:bg-stone-900/50 backdrop-blur-sm border border-stone-200/50 dark:border-stone-700/50 shadow-lg shadow-black/5 dark:shadow-black/20 rounded-full px-4 py-2 transition-all duration-300">
      {/* Status Indicator */}
      <a
